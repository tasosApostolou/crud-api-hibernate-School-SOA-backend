...
@Getter
@Setter
public class StudentReadOnlyDTO extends AbstractEntity {
   ...
   private   User user;
    ...
    public StudentReadOnlyDTO(Long id,String firstname, String lastname, String gender, String birthday, Cities city, User user) {
        this.setId(id);
